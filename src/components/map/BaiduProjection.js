...
import { transform, addCoordinateTransforms, addProjection } from 'ol/proj.js';
...
function smerc2bmerc(input, opt_output, opt_dimension) {
...
function bmerc2smerc(input, opt_output, opt_dimension) {
...
function bmerc2ll(input, opt_output, opt_dimension) {
    var output = baiduMercator.inverse(input, opt_output, opt_dimension);
    return bd09.toWGS84(output, output, opt_dimension);
}
function ll2bmerc(input, opt_output, opt_dimension) {
...
addCoordinateTransforms('EPSG:3857', baiduMercatorProj, smerc2bmerc, bmerc2smerc);
