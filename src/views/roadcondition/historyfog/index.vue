<template>
  <div>
    ...
    <el-table border ref="multipleTable" v-loading="loading" v-show="!loading" :data="datalist" tooltip-effect="dark"
      ...
      <el-table-column prop="name" label="传感器名称" width="150px"></el-table-column>
      <el-table-column prop="roadName" label="道路名称"></el-table-column>
       <el-table-column prop="roadCode" label="道路编号"></el-table-column>
       <el-table-column prop="concentration" label="浓度"></el-table-column>
       <el-table-column prop="visibility" label="能见度"></el-table-column>
       <el-table-column prop="timeUpdate" label="更新时间"></el-table-column>
...
<script>
import { doDelete } from '@/api/historyfog'
...
export default {
  ...
  methods: {
    beforeInit () {
      this.url = 'module/foghistoryinfos'
      const sort = 'id desc'
      this.params = {
        page: this.page + 1,
        sortType: sort,
