<template>
  <div>
    ...
    <el-table border ref="multipleTable" v-loading="loading" v-show="!loading" :data="datalist" tooltip-effect="dark"
      ...
      <el-table-column prop="concentration" label="浓度" width="150px"></el-table-column>
  ...
  methods: {
    ...
    showEdit (val) {
      ...
      this.$refs.form.dataForm = {
        id: val.id, sensorId: val.sensorId, concentration: val.concentration, visibility: val.visibility, timeStart: val.timeStart, timeEnd: val.timeEnd, timeUpdate: val.timeUpdate }
      this.$refs.form.startDraw()
    },
    removeById (id) {
