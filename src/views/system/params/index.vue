<template>
  <div>
    ...
    <el-table border ref="multipleTable" v-loading="loading" v-show="!loading" :data="datalist" tooltip-effect="dark"
      ...
      <el-table-column prop="types" label="参数类型" style="width: 30%"></el-table-column>
      <el-table-column prop="name" label="参数名称" style="width: 20%"></el-table-column>
      <el-table-column prop="value" label="参数值" style="width: 20%"></el-table-column>
      <el-table-column prop="memo" label="备注" style="width: 20%"></el-table-column>
...
export default {
  ...
  methods: {
    beforeInit () {
      this.url = 'api/system/params/list'
      const sort = 'ID asc'
      this.params = {
        pageNumber: this.page,
        sortType: sort,
        pageSize: this.pageSize,
        search_types: this.query.search_types,
    ...
    showEdit (val) {
      ...
      this.$refs.form.dataForm = { id: val.id, types: val.types, name: val.name, value: val.value, memo: val.memo }
    },
    removeById (id) {
