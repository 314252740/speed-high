<template>
  <div>
    <el-button-group>
      <el-button type="primary" icon="el-icon-share" @click="showAddDialog()">添加模块</el-button>
      <el-button type="success" icon="el-icon-plus" @click="showAddMenu()">添加功能菜单</el-button>
      <el-button type="info" icon="el-icon-plus" @click="doAddBtns()">添加增删改按钮</el-button>
      <el-button type="warning" icon="el-icon-plus">添加按钮</el-button>
      <el-button type="primary" icon="el-icon-edit" @click="showEdit()">修改</el-button>
      <el-button type="danger" icon="el-icon-delete" @click="removeNode()">删除</el-button>
    </el-button-group>
...
import { loadMenus, del, addBtns } from '@/api/menu'
export default {
  name: 'areaZtree',
  components: {
    eform
