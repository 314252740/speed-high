  ...
  <el-dialog :title="isAdd ? '新增字典' : '修改字典'" :closeOnClickModal="false" :visible.sync="visible" width="500px" label-width="80px">
    <el-form ref="form" :model="dataForm" size="small">
      ...
      <el-form-item label="编码">
        <el-input v-model="dataForm.code"  clearable required="true" autocomplete="off" style="width:330px;"></el-input>
      </el-form-item>
      <el-form-item label="备注">
        <el-input type="textarea" style="width:330px;" clearable :rows="3" v-model="dataForm.remark" autocomplete="off"></el-input>
      </el-form-item>
    </el-form>
