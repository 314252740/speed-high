<template>
  <div>
    ...
    <el-table border ref="multipleTable" v-loading="loading" v-show="!loading" :data="datalist" tooltip-effect="dark"
      ...
      <el-table-column prop="cntype" label="类型" width="200px" show-overflow-tooltip></el-table-column>
...
export default {
  ...
  methods: {
    ...
    showEdit (val) {
      ...
      this.$refs.form.dataForm = { id: val.id, name: val.name, code: val.code, type: val.cntype, remark: val.remark }
    },
    changeOptions () {
