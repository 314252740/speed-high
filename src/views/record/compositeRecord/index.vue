<template>
  <div>
    ...
    <el-table border ref="multipleTable" v-loading="loading" v-show="!loading" :data="datalist" tooltip-effect="dark"
      ...
      <el-table-column prop="name" label="复合屏名称"></el-table-column>
      <el-table-column prop="roadCond" label="路面状况"></el-table-column>
      <el-table-column prop="weatherCond" label="天气状况"></el-table-column>
      <el-table-column prop="visibilityStr" label="能见度"></el-table-column>
...
export default {
  ...
  methods: {
    beforeInit () {
      this.url = 'record/compositeRecords'
