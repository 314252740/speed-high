<template>
  <div>
    ...
    <el-table border ref="multipleTable" v-loading="loading" v-show="!loading" :data="datalist" tooltip-effect="dark"
      ...
      <el-table-column prop="typeName" label="组名" style="width: 30%"></el-table-column>
      <el-table-column prop="groupLeader" label="组长" style="width: 30%"></el-table-column>
      <el-table-column prop="deputyGroupLeader" label="副组长" style="width: 30%"></el-table-column>
      <el-table-column prop="workTask" label="工作职责" style="width: 20%"></el-table-column>
...
import { doDel } from '@/api/organizationTypes'
...
export default {
  ...
  methods: {
    beforeInit () {
      this.url = 'institutions/organization/organizationTypes'
      const sort = ''
      this.params = {
    ...
    showEdit (val) {
      ...
      this.$refs.form.dataForm = { id: val.id, typeName: val.typeName, groupLeader: val.groupLeader, deputyGroupLeader: val.deputyGroupLeader, workTask: val.workTask }
    },
    changeOptions () {
