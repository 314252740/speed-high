  ...
  <div>
    ...
    <el-table border ref="multipleTable" v-loading="loading" v-show="!loading" :data="datalist" tooltip-effect="dark"
      ...
      <el-table-column type="selection" width="55" align="center"></el-table-column>
       ...
       <el-table-column prop="enName" label="道路英文名称"></el-table-column>
       <el-table-column prop="code" label="道路编号"></el-table-column>
       <el-table-column prop="orgName" label="管理部门"></el-table-column>
  ...
  methods: {
    ...
    showEdit (val) {
      ...
      this.$refs.form.dataForm = {
        ...
        ip: val.ip,
        statusUseble: val.statusUseble,
        recSpeed: val.recSpeed,
        recBigCarSpeed: val.recBigCarSpeed,
        stdSpeed: val.stdSpeed,
        stdBigCarSpeed: val.stdBigCarSpeed,
        limitSpeed: val.limitSpeed,
        limitBigCarSpeed: val.limitBigCarSpeed,
        memo: val.memo,
        uploadcode: val.uploadcode,
        geom: val.geom,
        enName: val.enName,
        orgId: val.orgId,
        type: val.type,
