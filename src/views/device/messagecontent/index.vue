<template>
  <div>
    ...
    <el-table border ref="multipleTable" v-loading="loading" v-show="!loading" :data="datalist" tooltip-effect="dark"
      ...
      <el-table-column prop="enters" label="录入人" width="150px"></el-table-column>
      <el-table-column prop="content" label="内容"></el-table-column>
       <el-table-column prop="reviewer" label="道路名称"></el-table-column>
       <el-table-column prop="revieStatus" label="审核状态"></el-table-column>
...
<script>
import { doDelete } from '@/api/messagecontent'
...
export default {
  ...
  methods: {
    beforeInit () {
      this.url = 'module/messagecontentinfos'
      const sort = 'id desc'
      this.params = {
        page: this.page + 1,
        sortType: sort,
    ...
    showEdit (val) {
      ...
      this.$refs.form.dataForm = {
        id: val.id, type: val.type, reviewer: val.reviewer, revieStatus: val.revieStatus, enters: val.enters, messageId: val.messageId, content: val.content }
      this.$refs.form.startDraw()
    },
    removeById (id) {
