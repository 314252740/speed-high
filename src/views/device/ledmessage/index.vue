<template>
  <div>
    ...
    <el-table border ref="multipleTable" v-loading="loading" v-show="!loading" :data="datalist" tooltip-effect="dark"
      ...
      <el-table-column prop="sunBattery" label="太阳能电压" width="150px"></el-table-column>
      <el-table-column prop="ledNum" label="灯号"></el-table-column>
       <el-table-column prop="battery" label="电池电压"></el-table-column>
       <el-table-column prop="motherboard" label="主板温度"></el-table-column>
...
<script>
import { doDelete } from '@/api/ledmessage'
...
export default {
  ...
  methods: {
    beforeInit () {
      this.url = 'module/ledmessageinfos'
      const sort = 'led_num desc'
      this.params = {
        page: this.page + 1,
        sortType: sort,
    ...
    showEdit (val) {
      ...
      this.$refs.form.dataForm = {
        ...
        ledNum: val.ledNum,
        battery: val.battery,
        sunBattery: val.sunBattery,
        motherboard: val.motherboard,
        workingPower: val.workingPower,
        settingState: val.settingState,
