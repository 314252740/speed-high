<template>
  <el-dialog :title="isAdd ? '新增信息屏信息' : '修改信息屏信息'" :closeOnClickModal="false" :visible.sync="visible" width="1200px" label-width="80px" @open="changeHeight" @close="hide">
    <div class="container">
...
import {doAdd, doUpdate} from "@/api/message"
...
export default {
  ...
  data () {
    return {
      ...
      manufacturer: "", size: "", note: "", roadId: "",cameraIps:""},
      rules: {
        name: [
  ...
  methods: {
    ...
    startDraw() {
      ...
      //     });
      this.$nextTick(()=>{
        this.$refs.map.startDrawPoint("screenMessage", this.setLnglat, [this.dataForm.longitude, this.dataForm.latitude]);
      })
    },
    setLnglat(point) {
    ...
    resetForm () {
      ...
      manufacturer: "", size: "", note: "", roadId: "",cameraIds:"",sign:""}
    },
    doSubmit () {
