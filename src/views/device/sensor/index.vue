<template>
  <div>
    ...
    <el-table border ref="multipleTable" v-loading="loading" v-show="!loading" :data="datalist" tooltip-effect="dark"
      ...
      <el-table-column prop="name" label="检测仪名称" width="200px"></el-table-column>
...
<script>
import { doDelete } from '@/api/sensor'
