<template>
  <div>
    ...
    <el-table border ref="multipleTable" v-loading="loading" v-show="!loading" :data="datalist" tooltip-effect="dark"
      ...
      <el-table-column prop="name" label="引导灯名称" width="150px"></el-table-column>
  ...
  methods: {
    ...
    showEdit (val) {
      ...
      this.$refs.form.dataForm = {
        ...
        controlModel: val.controlModel,
        warningModel: val.warningModel,
        nightModel: val.nightModel,
