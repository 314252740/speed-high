<template>
  <el-dialog :title="isAdd ? '新增引导灯基础数据信息' : '修改引导灯基础数据信息'" :closeOnClickModal="false" :visible.sync="visible" width="1200px" label-width="80px" @open="changeHeight" @close="hide">
    <div class="container">
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="模式ID" prop="modelId">
                <el-input clearable v-model="dataForm.modelId" required="true" minlength="6" maxlength="20"  autocomplete="off" ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="mac地址" prop="mac">
                <el-input clearable v-model="dataForm.mac" required="true" minlength="6" maxlength="20"  autocomplete="off" ></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-row>
            <el-col>
              <el-form-item label="工作状态" prop="workingStatus">
                <el-radio v-model="dataForm.workingStatus" :label="0">工作</el-radio>
                <el-radio v-model="dataForm.workingStatus" :label="1">未工作</el-radio>
              </el-form-item>
            </el-col>
            <el-col>
              <el-form-item label="使用状态" prop="useState">
                <el-radio v-model="dataForm.useState" :label="0" >使用</el-radio>
                <el-radio v-model="dataForm.useState" :label="1">未使用</el-radio>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col>
              <el-form-item label="控制模式" prop="controlModel">
                <el-radio v-model="dataForm.controlModel" :label="0" >是</el-radio>
                <el-radio v-model="dataForm.controlModel" :label="1">否</el-radio>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col>
              <el-form-item label="告警模式" prop="warningModel">
                <el-radio v-model="dataForm.warningModel" :label="0" >是</el-radio>
                <el-radio v-model="dataForm.warningModel" :label="1">否</el-radio>
              </el-form-item>
            </el-col>
            <el-col>
              <el-form-item label="夜间模式" prop="nightModel">
                <el-radio v-model="dataForm.nightModel" :label="0" >是</el-radio>
                <el-radio v-model="dataForm.nightModel" :label="1">否</el-radio>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
...
import {doAdd, doUpdate} from "@/api/led"
...
export default {
  ...
  methods: {
    ...
    startDraw () {
      ...
      // })
      this.$nextTick(() => {
        this.$refs.map.startDrawPoint("led", this.setLnglat, [this.dataForm.longitude, this.dataForm.latitude])
      })
    },
    setLnglat (point) {
