<template>
  <div>
    ...
    <el-table border ref="multipleTable" v-loading="loading" v-show="!loading" :data="datalist" tooltip-effect="dark"
      ...
      <el-table-column prop="name" label="复合屏名称" min-width="160px"></el-table-column>
      <el-table-column prop="visibilityStr" label="能见度" width="80px"></el-table-column>
      <el-table-column prop="roadCond" label="路面状况" width="80px"></el-table-column>
      <el-table-column prop="weatherCond" label="天气状况" width="80px"></el-table-column>
      <el-table-column prop="visibleIp" label="能见度ip地址"></el-table-column>
      <el-table-column prop="cnName" label="道路名称" min-width="165px"></el-table-column>
...
<script>
import { doDelete } from '@/api/composite'
import initData from '@/mixins/initData'
import search from './module/search'
import eform from './module/form.vue'
import { doUpdateWorkWay } from '@/api/speedlimit'
...
export default {
  ...
  methods: {
    ...
    beforeInit () {
      this.url = 'module/compositepanelinfos'
    ...
    showEdit (val) {
      ...
      this.$refs.form.dataForm = {
        id: val.id,
        visibleIp: val.visibleIp,
        weatherIp: val.weatherIp,
        roadIp: val.roadIp,
        name: val.name,
        cnName: val.cnName,
        enName: val.enName,
        ...
        roadCond: val.roadCond,
        visibility: val.visibility,
        weatherCond: val.weatherCond,
        note: val.note,
