<template>
  <div>
    ...
    <el-col :span="24">
      <div style="margin-bottom:10px">
        <el-button-group>
          ...
          <el-button type="warning" icon="el-icon-warning" @click="fogWebsocket()">WebSocket Fog</el-button>
        </el-button-group>
      </div>
    </el-col>
    <el-table border ref="multipleTable" v-loading="loading" v-show="!loading" :data="datalist" tooltip-effect="dark"
      ...
      <el-table-column prop="name" label="摄像机名称" width="150px"></el-table-column>
...
<script>
import { doDelete } from '@/api/camera'
