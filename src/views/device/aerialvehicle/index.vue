<template>
  <div>
    ...
    <el-table border ref="multipleTable" v-loading="loading" v-show="!loading" :data="datalist" tooltip-effect="dark"
      ...
      <el-table-column prop="name" label="无人机名称" width="150px"></el-table-column>
...
<script>
import { doDelete } from '@/api/aerialvehicle'
...
export default {
  ...
  methods: {
    beforeInit () {
      this.url = 'module/aerialvericleinfos'
    ...
    showEdit (val) {
      ...
      this.$refs.form.dataForm = {
        ...
        note: val.note,
        effectiveLoad: val.effectiveLoad,
        electricity: val.electricity,
        flightControl: val.flightControl,
        batteryLife: val.batteryLife,
        flightHigh: val.flightHigh,
        flightSpeed: val.flightSpeed,
        windResistance: val.windResistance,
        foldingSize: val.foldingSize,
        batteryNumber: val.batteryNumber,
        planeMaterial: val.planeMaterial,
        resolution: val.resolution,
        effectiveIstance: val.effectiveIstance,
        groundStation: val.groundStation,
        automaticReturn: val.automaticReturn,
        nightNavigation: val.nightNavigation,
        operations: val.operations,
        transmissionChannel: val.transmissionChannel,
