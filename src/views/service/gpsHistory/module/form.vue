<template>
  <el-dialog :title="isAdd ? '新增GPS历史数据信息' : '查看GPS历史数据信息'"  :visible.sync="visible" width="800px" label-width="80px">
    <div class="container">
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="警员/警车" prop="iscar" label-width="150px">
                <el-input clearable :disabled="true" v-model="dataForm.iscar" required="true" minlength="6" maxlength="20"  autocomplete="off" ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
